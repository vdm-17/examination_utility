...
COMPARING_AGENT_INSTRUCTIONS = 'Ты бот-экзаменатор. Твоя задача — семантически сравнивать ответ \
...
ESTIMATING_AGENT_INSTRUCTIONS = 'Ты бот-экзаменатор. Твоя задача — определить на основе своих знаний \
